...
{    
    public function getAdverts($page, $nbPerPage)
    {
        $query = $this->createQueryBuilder('a')
            ...
            ->addSelect('cat')
            // Jointure sur l'attribut skills
        ...
        return new Paginator($query, true); // return $query->getResult();
    ...
    public function myFindAll()
    {
        ...
        $queryBuilder1 = $this->_em->createQueryBuilder()->select('a')->from($this->_entityName, 'a');
    ...
    public function isFlood ($ip, $lapstime)
    {
        return true;
    }
